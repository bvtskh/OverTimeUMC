...
namespace OverTime.DataBase
{
    ...
    {
        public DBContext()
            : base("data source=172.28.10.28;initial catalog=OverTime;persist security info=True;user id=sa;password=umc@123;MultipleActiveResultSets=True;App=EntityFramework")
        {
        }

        public virtual DbSet<sysdiagram> sysdiagrams { get; set; }
        public virtual DbSet<Tbl_DailyOverTime> Tbl_DailyOverTime { get; set; }
        public virtual DbSet<Tbl_FCHumanOT> Tbl_FCHumanOT { get; set; }
        public virtual DbSet<Tbl_ForecastOT> Tbl_ForecastOT { get; set; }
        public virtual DbSet<Tbl_GroupSupporter> Tbl_GroupSupporters { get; set; }
        ...
        public virtual DbSet<Tbl_MailSetting> Tbl_MailSetting { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tbl_MailSetting>()
                .Property(e => e.Dept)
                .IsUnicode(false);
